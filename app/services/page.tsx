  ...
  return (
    <section className="my-16 px-6 md:px-20 text-neutral-200">
      ...
      <div className="flex flex-col items-center text-center mb-20">
        <h4 className="text-sm uppercase tracking-widest text-neutral-300">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        <div>
          <h2 className="text-5xl font-semibold mb-4">Web Development</h2>
        ...
        {/* Placeholder box */}
        <div className="h-84 border border-neutral-400 bg-[#3a2f28] rounded-md" />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div>
          <h2 className="text-5xl font-semibold mb-4">App Development</h2>
          <p className="text-neutral-400 leading-relaxed text-xl">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        <div>
          <h2 className="text-5xl font-semibold mb-4">UI & UX Design</h2>
          <p className="text-neutral-400 leading-relaxed text-xl">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h2 className="text-5xl font-semibold mb-4">Shopify Store</h2>
          <p className="text-neutral-400 leading-relaxed text-xl">
